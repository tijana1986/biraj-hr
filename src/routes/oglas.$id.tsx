      ...
      ? [
          ...
          },
          {
            ...
            children: JSON.stringify({
              ...
              "@type": "BreadcrumbList",
              itemListElement: [
                { "@type": "ListItem", position: 1, name: "Početna", item: "https://biraj.com.hr/" },
                { "@type": "ListItem", position: 2, name: "Katalog", item: "https://biraj.com.hr/browse" },
                { "@type": "ListItem", position: 3, name: loaderData.cat.name, item: `https://biraj.com.hr/kategorija/${loaderData.cat.slug}` },
                { "@type": "ListItem", position: 4, name: loaderData.sub.name, item: `https://biraj.com.hr/kategorija/${loaderData.cat.slug}/${loaderData.sub.slug}` },
